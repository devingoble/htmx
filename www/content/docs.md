...
```html
<script
  src="https://cdn.jsdelivr.net/npm/htmx.org@5.0.0/dist/htmx.min.js"
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/htmx.org@5.0.0/dist/htmx.js"
...
Download `htmx.min.js` [from jsDelivr](https://cdn.jsdelivr.net/npm/htmx.org@5.0.0/dist/htmx.min.js) and add it to the appropriate directory in your project
...
```html
<template>
  <tr id="message" hx-swap-oob="true">
    <td>Joe</td>
    <td>Smith</td>
  </tr>
</template>
...
is fired on _every_ trigger for a request (not just on elements that have a `hx-confirm` attribute) and can be used
...
```HTML
<head>
    <script src="https://cdn.jsdelivr.net/npm/htmx.org@5.0.0/dist/htmx.min.js" integrity="sha384-/TgkGk7p307TH7EXJDuUlgG3Ce1UVolAOFopFekQkkXihi5u/6OCvVKyz1W+idaz" crossorigin="anonymous"></script>
