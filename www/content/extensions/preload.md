...
<body hx-ext="preload">
  <ul preload>
    <li>
      <a href="/server/1"
        >This will be preloaded because of the attribute in the node above.</a
      >
    </li>
    <li>
      <a href="/server/2">This will also be preloaded for the same reason.</a>
    </li>
...
```html
<div hx-ext="preload">
  <a href="/my-next-page" preload="mouseover" preload-images="true"
    >Next Page</a
  >
</div>
```
...
```html
<a href="/server/1" preload="mousedown"
  >This will be preloaded when the user begins to click.</a
>
```
