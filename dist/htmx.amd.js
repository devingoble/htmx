  ...
  var htmx = (function () {
    ...
    function addTriggerHandler(elt, triggerSpec, nodeData, handler) {
      if (triggerSpec.trigger === "revealed") {
        ...
        !nodeData.firstInitCompleted &&
        triggerSpec.trigger === "load"
      ) {
    ...
    function getValueFromInput(elt) {
      if (elt instanceof HTMLSelectElement && elt.multiple) {
        return toArray(elt.querySelectorAll("option:checked")).map(function (
          e
        ) {
      ...
      if (attributeValue) {
        ...
        if (evaluateValue) {
          varsValues = maybeEval(
            ...
            function () {
              if (event) {
                return Function("event", "return (" + str + ")").call(
                  elt,
                  event
                );
              } else {
    ...
    ready(function () {
      ...
      body.addEventListener("htmx:abort", function (evt) {
        const target =
          /** @type {CustomEvent} */ (evt).detail.elt || evt.target;
